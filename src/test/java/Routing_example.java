 ...
 */
public final class Routing_example {

    private Routing_example() {        
    }
    ...
    public static void main(String args[]) throws Exception {
        ...
        context.addRoutes(new RouteBuilder() {
            public void configure() {
                from("test-jms:topic:test.a").to("test-jms:topic:test.b");
        ...
        // START SNIPPET: e5
//        for (int i = 0; i < 10; i++) {
//            template.sendBody("test-jms:queue:test.queue.a", "Test Message: " + i);
//        }
        // END SNIPPET: e5
